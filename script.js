document.addEventListener('DOMContentLoaded', () => {
    ...
    const PLANS = [50, 100, 200, 300, 400, 1000, 1500, 2000, 3000, 4000, 5000, 10000, 15000, 20000, 30000, 40000, 50000];
    ...
    if (sliderElem) {
        sliderElem.addEventListener('input', function() {
            investmentSlider.value = PLANS[sliderElem.value];
            calculate();
        });
    }

    function calculate() {
        const principal = parseFloat(investmentSlider.value) || 50;
